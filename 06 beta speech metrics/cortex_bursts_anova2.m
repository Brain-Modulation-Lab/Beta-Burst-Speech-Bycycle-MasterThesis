% This script plots on the cortical and subcortical areas the significant (pvalues<0.05) F or t test statistic from the ANOVA2 or t test for all the combinations of burst measures and trial subdivisions
