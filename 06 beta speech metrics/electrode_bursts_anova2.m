% This script plots the discrete and continuous trend of all burst measures for each trial subdivision for each electrode. Statistics about the ANOVA2 and t tests are plotted.
