% This script create an annotation txt file for every burst measure saving for every trials subdivision:
% ANOVA2 results considering all five experimental windows
% ANOVA2 results considering only the speech and rebound windows
% t test results between the two trial subdivisions internal to each window

% windows = 'baseline','stimulus','prespeech','speech','rebound'
% burst measure = 'frequency','probability','duration','volt_amp','time_rdsym','time_ptsym'
% trial subdivisions = 'Volume', 'Accuracy','Reaction time', 'Speech rate','Jitter mean', 'Jitter CV','Shimmer mean', 'Shimmer CV'
