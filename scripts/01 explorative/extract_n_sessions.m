...
% This script is for data exploration. It calculates n patients with Parkinson's Disorder and Essential Tremor with DBS in STN and VIM, and n sessions per each cases
% See fig "n_sessions.png"
